# Generated by Django 2.0.7 on 2018-08-26 13:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cashless', '0007_transaction_transaction_type'),
    ]
    ...
    operations = [
        migrations.RenameField(
            ...
            old_name='fsm_value',
            new_name='voucher_value',
        ),
        migrations.RenameField(
            model_name='transaction',
            old_name='fsm_value_currency',
            new_name='voucher_value_currency',
        ),
        migrations.AddField(
            model_name='cash',
            name='voucher_value',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='GBP', max_digits=14),
        ),
        migrations.AddField(
            model_name='cash',
            name='voucher_value_currency',
