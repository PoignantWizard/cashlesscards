# Generated by Django 2.0.7 on 2018-09-01 19:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cashless', '0009_cash_voucher_date'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('last_applied', models.DateField(default=datetime.date.today)),
            ],
        ),
        ...
        migrations.AlterModelOptions(
            name='customer',
            options={'ordering': ['surname', 'first_name'], 'permissions': (('can_add_voucher', 'Add vouchers to a customer'),), 'verbose_name_plural': 'customers'},
        ),
        ...
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cashless.Customer'),
        ),
        migrations.AddField(
            model_name='voucherlink',
            name='voucher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cashless.Voucher'),
        ),
    ]
